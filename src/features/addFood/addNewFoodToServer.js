import { asyncRequestStatus, newFood, ASYNC_REQUEST_STATUS_ENUM } from '../../Actions';
...
const addNewFoodToServer = food => dispatch => {
    ...
    server.addFood(food)
        .then(data => {
            ...
            setTimeout(() => dispatch(asyncRequestStatus(ASYNC_REQUEST_STATUS_ENUM.HIDE_NOTIFICATION)), 4000);
        });
}
